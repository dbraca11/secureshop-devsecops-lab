...
```mermaid
graph TD
    subgraph 1. Shift-Left Security (CI/CD)
    ...
    subgraph 2. Container & IaC Security
        E --> F[Paso 6: Docker Build]
        F --> G[Paso 7: Trivy Image Scan]
        H[Manifiestos Kubernetes] --> I[Paso 8: Checkov IaC Scan]
    end

    subgraph 3. Kubernetes Runtime & Security
        G --> J[Paso 9: Despliegue en K8s - Namespace secureshop]
        I --> J
        J --> K[Paso 10: DAST - OWASP ZAP API Testing]
        J --> L[Paso 11 & 12: Runtime Security - Falco con eBPF & Detección de Intrusos]
    end

    subgraph 4. Observability Stack
        J --> M[Paso 13: Prometheus & Grafana - kube-prometheus-stack]
        M --> N[Paso 14: Visualización de Métricas & Dashboards kubernetes-mixin]
    end
